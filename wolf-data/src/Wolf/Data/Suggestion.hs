...
readSuggestion ::
     forall a m. (MonadIO m, MonadReader DataSettings m, FromJSON a, Hashable a)
  => SuggestionType
  -> SuggestionUuid
    ...
    forM ds $ \ad ->
      case stripProperPrefix ssd ad of
        ...
        Just rd -> do
          ...
          suggestionTypeRepoUnused <- readAll readUnusedSuggestionIndex typ
          suggestionTypeRepoUsed <- readAll readUsedSuggestionIndex typ
