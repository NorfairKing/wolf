...
data ExportProblem
  = ExportWarningMissingNoteIndex PersonUuid NoteUuid
  | ExportWarningMissingNote NoteUuid
  | ExportWarningIncorrectNoteIndex NoteIndex NoteIndex
  | ExportWarningMissingRelevantPerson PersonUuid NoteUuid
  | ExportWarningMissingRelevantNote NoteUuid PersonUuid
  deriving (Show, Eq, Generic)
...
prettyShowExportProblem (ExportWarningMissingRelevantNote nu pu) =
  ...
  show pu ++ " does not mention the note " ++ show nu ++ " in their noteIndex."
